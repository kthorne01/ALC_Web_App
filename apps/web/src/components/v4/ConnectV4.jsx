        ...
        {[
          {
            ...
            time: '11:00 AM',
            desc: 'Worship, word, and real community every Sunday morning.',
          },
          {
            num: '02',
            label: 'WEDNESDAY NIGHT',
            time: '7:30 PM',
            desc: 'Mid-week prayer and Bible study — go deeper.',
          },
          {
            num: '03',
            label: "NEW HERE?",
            desc: "First time? We'd love to welcome you. Find out what to expect.",
          ...
          <div key={item.num} className="flex flex-col">
            ...
            <h3 className="font-heading font-bold text-black uppercase tracking-[0.08em] mb-2"
